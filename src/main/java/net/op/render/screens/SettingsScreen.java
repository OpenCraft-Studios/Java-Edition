...
import static net.op.language.Translations.*;
...
public class SettingsScreen extends Screen {
	...
	public void render(Graphics g) {
		...
		font.drawShadow(g, Locales.CURRENT[0], (width - 175) / 2 + 62, height - 66, donesel ? 0xFFFFA0 : 0xFFFFFF);
		...
		font.drawShadow(g,
				Locales.CURRENT[currentTab.equalsIgnoreCase("generalTab") ? OPTIONS_GENERALTAB : OPTIONS_LOCALESTAB],
				(width - 400) / 2 + 155, 37, 0xFFFFFF);
