...
public class MenuScene extends Scene {
	...
	public static final Resource RESOURCE = Resource.format("opencraft.scene:menu");
	public static final Sound[] SOUNDS = { Sound.MENU3, Sound.MENU2, Sound.MENU3_SYNTHWAVE };
